...
const translations = {
  es: {
    ...
    'topbar.profileOptions': 'Configurar',
    'topbar.extract': '📥 Extraer CV',
    'topbar.ats': '✨ Analizar ATS',
    'topbar.backup': '💾 Respaldar',
    'topbar.load': '📂 Cargar',
    'topbar.pdf': '🖨️ Exportar PDF',
    ...
    'tmpl.harvard': '🎓 Harvard Classic (Ivy League ATS)',
    'tmpl.timeline': '⏳ Timeline Ejecutivo (Hitos & Cronología)',
    'tmpl.data': '📊 Industrial & Data Analyst (Operaciones)',
    'tmpl.modern': '👔 Moderna Ejecutiva (Doble Columna)',
    'tmpl.compact': '📄 Elegante Compacta (1 Página ATS)',
    'theme.navy': 'Azul Ejecutivo / Tech',
    'theme.crimson': 'Harvard Crimson / Burdeos',
    'theme.oxford': 'Azul Oxford / Royal Navy',
    'theme.slate': 'Pizarra / Charcoal Moderno',
    'theme.teal': 'Esmeralda Data / BI',
    'theme.emerald': 'Verde Bosque / Corporativo',
    'theme.amber': 'Ámbar / Bronce Ejecutivo',
    'theme.plum': 'Borgoña / Ciruela Elegante',
  ...
  en: {
    ...
    'topbar.profileOptions': 'Configure',
    'topbar.extract': '📥 Extract CV',
    ...
    'tmpl.harvard': '🎓 Harvard Classic (Ivy League ATS)',
    'tmpl.timeline': '⏳ Executive Timeline (Milestones & Career)',
    'tmpl.data': '📊 Industrial & Data Analyst (BI/Ops)',
    'tmpl.modern': '👔 Modern Executive (Two Columns)',
    'tmpl.compact': '📄 Elegant Compact (1 Page ATS)',
    'theme.navy': 'Navy Executive / Tech',
    'theme.crimson': 'Harvard Crimson / Burgundy',
    'theme.oxford': 'Oxford Blue / Royal Navy',
    'theme.slate': 'Slate Charcoal / Modern',
    'theme.teal': 'Teal Data / BI',
    'theme.emerald': 'Emerald Forest / Corporate',
    'theme.amber': 'Amber / Executive Bronze',
    'theme.plum': 'Plum / Elegant Burgundy',
